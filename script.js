...
function showurls() {
  ...
  for (let i = 0; i < show.length; i++) {
    ...
    textSize(s * 20);
    text("Age", width / 4, height / 2.8 + (i * height) / 2.6);
    text("Admin", (width / 4) * 3, height / 2.8 + (i * height) / 2.6);
  ...
  if (
    ...
    window.location.replace("https://education.minecraft.net/en-us/get-started/download");
    open = false;
  }
  type.hide();
}
